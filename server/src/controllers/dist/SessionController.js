...
var SessionController = /** @class */ (function () {
    ...
    SessionController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, usuario, senha, user, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        user = (_b.sent())[0];
                        if (!user) {
                            return [2 /*return*/, res.status(401).json({ message: 'Usuário ou senha incorretos' })];
                        }
                        if (!bcryptjs_1["default"].compareSync(senha, user.senha)) {
                            return [2 /*return*/, res.status(401).json({ message: 'Usuário ou senha incorretos' })];
                        }
                        return [2 /*return*/, res
                                .status(201)
                                .json({
                                id: user.id_usuario,
                                token: generateToken_1["default"]({ id: user.id_usuario })
                            })];
                    case 3:
                        error_1 = _b.sent();
                        return [2 /*return*/, res
